...
{
    // Concrete IServiceI implementation using the CreatableBase lifecycle (sync create + optional async init).
    internal class ServiceI : CreateableBindableBase<IServiceI, ServiceI, IWpfBase>, IServiceI
    {

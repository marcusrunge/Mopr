...
namespace MarcusRunge.Mopr.Workbench.Services.Application.Implementations.Media
{
    ...
    {
        internal MediaService(IApplicationBase? applicationBase) : base(applicationBase) => _imageSourceService = Media.ImageSourceService.Create(this, CreationLifetime.Scoped);

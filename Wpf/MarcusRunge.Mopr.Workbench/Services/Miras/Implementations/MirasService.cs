...
namespace MarcusRunge.Mopr.Workbench.Services.Miras.Implementations
{
    ...
    internal class MirasService : CreateableBindableBase<IMirasService, MirasService, IMirasBase>, IMirasService
    {
        private IMirasBase? _base;
        private IMirasBase Base => _base ?? throw new InvalidOperationException("Service has not been initialized.");
        ...
        public Task<MirasOperationResult> CheckRepositoryAsync(CancellationToken cancellationToken = default)
        {
            throw new NotImplementedException();
        }

        protected override void OnCreate(IMirasBase @base)
        {
            // What happens here:
